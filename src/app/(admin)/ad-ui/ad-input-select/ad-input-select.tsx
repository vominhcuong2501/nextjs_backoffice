...
import { AdTooltipPopup } from '../ad-tooltip-popup'
import type { TooltipPopupProps } from '../ad-tooltip-popup'
...
export const AdInputSelect = <T extends FieldValues>(props: UseControllerProps<T> & InputSelectProps) => {
    const {
        option,
        control,
        defaultValue,
            ...
            {nameLabel && (
                <div className='flex gap-1 w-fit'>
                    <label
                        htmlFor={id}
                        className={cn(
                            'text-md lg:!text-xl font-bold text-ad-black',
                            classNameLabel,
                    ...
                    {tooltip && <AdTooltipPopup {...tooltip} />}
                </div>
            )}
            {isMounted && (
                <Select
