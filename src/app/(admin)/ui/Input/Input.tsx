...
export const Input = forwardRef<HTMLInputElement, InputProps>(function Input(
    ...
    const inputBaseClasses =
        'text-md lg:!text-xl font-light text-black w-full appearance-none outline-none ring-0 bg-transparent transition-all duration-300'

    const defaultInput = cn(
        inputBaseClasses,
        'rounded-[2px] border hover:border-blue hover:shadow-1 transition-all duration-300 border-gray-1 p-3 placeholder:text-16 placeholder:font-light lg:placeholder:!text-xl placeholder:text-placeholder disabled:bg-disable disabled:pointer-events-none focus:border-secondary focus:shadow-8 lg:!text-20 text-16',
    ...
    return (
        <div className={className}>
            <div className='relative flex flex-col gap-2'>
                ...
                {isCountMaxLength && (
                    <p className='text-gray-5 text-12 absolute right-0 -bottom-5'>
