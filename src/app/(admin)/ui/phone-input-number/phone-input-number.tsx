...
import './phone-input-number-style-default.css'
import { cn } from '@libs'
...
export const PhoneInputNumber = <T extends FieldValues>({
    ...
    return (
        <div className={`input-normal ${className}`} data-te-input-wrapper-init>
            <div className={cn('relative flex flex-col gap-2', classSpace)}>
                ...
                <input
                    className={cn(
                        'text-md hover:border-blue hover:shadow-1 lg:!text-xl lg:!py-3 lg:!leading-1 py-[12px] text-black border-gray-1 rounded-[2px] border px-2.5 placeholder:text-md lg:placeholder:text-xl placeholder:text-placeholder w-full appearance-none outline-none ring-0 focus:border-secondary focus:shadow-7 disabled:bg-disable font-light transition-all duration-300',
                        phoneFieldState?.error && 'border-error',
                        isEdit && 'bg-gray-22',
                        classNameInput
                    )}
