    ...
    const options: HTMLReactParserOptions = {
        ...
        replace: (domNode) => {
            ...
            switch (typedDomNode.name) {
                ...
                case 'iframe':
                    // Return a 'LazyIframe' component with the node's attributes as props
                    return (
                        <LazyIframe {...attributesToProps(typedDomNode.attribs)}>
                            {typedDomNode.children && domToReact(typedDomNode.children as DOMNode[], options)}
                        </LazyIframe>
                    )
                ...
                case 'custom-button':
                    ...
                    return (
                        <Button {...attributesToProps(typedDomNode.attribs)}>
                            {typedDomNode.children && domToReact(typedDomNode.children as DOMNode[], options)}
                        </Button>
                    )
                ...
                case 'motion':
                    return (
                        <Motion {...attributesToProps(typedDomNode.attribs)}>
                            {typedDomNode.children && domToReact(typedDomNode.children as DOMNode[], options)}
                        </Motion>
                    )
            }
